...
class Http {
     ...
     * @return mixed
     */
	static public function curlGet($url,$timeout=15){
		$ch = curl_init();
	...
	static public function curlPostOwn($url,$data,$timeout=15){
		$ch = curl_init();
...
// 		$header = "Accept-Charset: utf-8";
	 ...
	 * @return mixed
	 */
	static public function curlUploadFile($remote,$file,$https=false) {
		$ch = curl_init();
