...
<html lang="zh-CN">
	<head>
		...
		<script type="text/javascript">
			var locationClassicHash = 'shop-<?php echo ($_GET["shop_id"]); ?>';
			var now_store_id = '<?php echo ($_GET["shop_id"]); ?>'
			...
			var shopShareUrl = "<?php echo ($config["site_url"]); echo U('Shop/index',array('openid'=>$_SESSION['openid']));?>&shop-id=";
			var shopReplyUrl = "<?php echo ($config["site_url"]); ?>/index.php?g=Index&c=Reply&a=ajax_get_list&order_type=3&parent_id=";
			 var nowIndex = '<?php echo ($nowIndex); ?>', cartid = '<?php echo ($cartid); ?>', spellfrm = '<?php echo ($_GET["frm"]); ?>';
			 var spell_add_cart = '<?php echo ($config["site_url"]); ?>/wap.php?c=Shop&a=addNew', spell_cart_url = '<?php echo ($config["site_url"]); ?>/wap.php?c=Shop&a=', deliverExtraPrice = 0;
...
<script type="text/javascript">
	$(function(){
        ...
        <!--div id="searchFloor" >
			...
			<div class="addHtml">    
				<div id="GoodsSearchBar" style="height: 557px;">  
					<ul>        
						<li class="product_139" data-product_id="139" data-product_price="12" data-product_name="cws1" data-stock="-1" data-packing_charge="0.00" data-max_num="0" data-o_price="12" data-is_seckill="false">      
							<div class="position_img">               
								<img src="http://www.group.com/upload/goods/000/000/001/5719f88e5b13a.jpg">             
							</div>      
							<div class="product_text">       
								<div class="title" style="padding-left: 0px;">cws1</div>              
								<div class="sale"> 好评0</div>                      
								<div class="price">￥12</div>                    
							</div>             
							<div class="product_btn plus addCon" style="z-index:10"></div>
							<div class="product_btn min"></div>
							<div class="product_btn number productNum-139">1</div>
							<div class="product_btn min"></div>
							<div class="product_btn number productNum-btn">1</div>       
							<div class="bgPlusBack"></div>       <div class="bgMinBack"></div>           
						</li>       

						<li class="product_143" data-product_id="143" data-product_price="11.11" data-product_name="测试11" data-stock="-1" data-packing_charge="0.00" data-max_num="0" data-o_price="11.11" data-is_seckill="false">      
							<div class="position_img">               
								<img src="http://www.group.com/upload/goods/000/000/001/">             
							</div>      
							<div class="product_text">       
								<div class="title" style="padding-left: 0px;">测试11</div>              
								<div class="sale"> 好评0</div>                      
