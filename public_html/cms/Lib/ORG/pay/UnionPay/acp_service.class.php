...
class AcpService {
     ...
     * @return 是否成功
     */
    static function validate($params, $middle_cert_file = '', $roor_cert_file = '', $cert_path = '') {
        ...
        if($params['signMethod']=='01') {
            ...
            if($params['version']=='5.0.0'){
                ...
                $strCert = CertUtil::verifyAndGetVerifyCert($strCert, $middle_cert_file, $roor_cert_file);
                if($strCert == null){
