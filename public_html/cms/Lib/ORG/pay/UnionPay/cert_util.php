<?php
include_once 'acp_service.class.php';
...
//         $logger->LogInfo("加密证书读取成功，序列号：" . $cert->certId);
    ...
    public static function verifyAndGetVerifyCert($certBase64String, $middle_cert_file, $roor_cert_file){
...
// 			$logger->LogInfo("signPubKeyCert has expired");
		...
		$result = openssl_x509_checkpurpose($certBase64String, X509_PURPOSE_ANY, array($roor_cert_file, $middle_cert_file));
		if($result === FALSE){
