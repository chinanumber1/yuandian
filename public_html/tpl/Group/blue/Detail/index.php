...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/shopping.css?2"/>
		...
		<div class="body"> 
			...
			<article class="product cf">
				...
				<div class="product_top_line">
					<div class="product_name"><span>{pigcms{$now_group.s_name}</div>
								...
								<div class="product_info_list">
									<ul>
										...
										<li class="cf">
											...
											<div class="priduct_shop"><a href="{pigcms{$config.site_url}/merindex/{pigcms{$now_group.mer_id}.html" target="_blank">【{pigcms{$now_group.prefix_title}】{pigcms{$now_group.merchant_name}</a>&nbsp;&nbsp;&nbsp;<span>|</span>&nbsp;&nbsp;&nbsp;<a class="see_anchor" data-anchor="business-info" href="javascript:void(0);">查看地址/电话</a></div>
										</li>
										<li class="cf">
			...
			<div class="content_left">
				<div class="content_navbar" id="J-content-navbar">
					<ul class="cf">
						...
						<if condition="$now_group['pin_num'] eq 0 AND  ($now_group['trade_type'] eq '' OR $now_group['trade_info'] eq '' OR $now_group['trade_info'] eq 0) " >
							<if condition="$now_group['end_time'] gt $_SERVER['REQUEST_TIME'] AND $now_group['begin_time'] lt $_SERVER['REQUEST_TIME'] AND $now_group['type'] eq 1">
