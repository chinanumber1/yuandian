									...
									<div class="category_list_img">
												...
												<div class="bmbox_list">
													...
													<div class="bmbox_list_li">
														<ul class="cf">
															...
															<li class="open_windows" data-url="{pigcms{$config.site_url}/mergoods/{pigcms{$vo.mer_id}.html">{pigcms{$config.shop_alias_name}</li>
										...
										<div class="datal">
											<a href="{pigcms{$vo.url}" target="_blank">
												<div class="category_list_title">{pigcms{$vo.group_name}</div>
												<div class="category_list_description">【{pigcms{$vo.prefix_title}】{pigcms{$vo.merchant_name}</div>
											</a>
											<div class="deal-tile__detail cf">
												<span class="price">&yen;<strong>{pigcms{$vo.price}<if condition="$vo.extra_pay_price  neq ''">{pigcms{$vo.extra_pay_price}</if></strong> </span>
												<span>门店价 &yen;{pigcms{$vo.old_price}<if condition="$vo.extra_pay_price  neq ''">{pigcms{$vo.extra_pay_price}</if></span>	
