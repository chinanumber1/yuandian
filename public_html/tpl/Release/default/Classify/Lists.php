   ...
   <div id="header"  class="mainpage">
    <div id="headerinside">
     ...
     <form action="{pigcms{$siteUrl}/classify/searchlist.html" method="get" name="mysearch">
      <div id="searchbar">
       <div id="saerkey">
        <span><input type="text" id="keyword" name="keystr" class="keyword" value="<if condition="$_GET['keystr']">{pigcms{$_GET['keystr']}<else/>请填写关键词进行搜索</if>" onblur="if(this.value=='')this.value='请填写关键词进行搜索',this.className='keyword'" onfocus="if(this.value=='请填写关键词进行搜索')this.value='',this.className='keyword2'" /></span>
       </div>
       <div class="inputcon">
