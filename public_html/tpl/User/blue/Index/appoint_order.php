											...
											<div class="order-cell order-info">
												<div class="deal-info cf">
													...
													<div class="info-detail">
														...
														<if condition="$vo['appoint_date']"><p>预约时间：<?php echo date('Y-m-d', strtotime($vo['appoint_date'])); ?><php>if($vo['appoint_date']!=$vo['appoint_time']){</php>&nbsp;&nbsp;{pigcms{$vo.appoint_time}<php>}</php></p>
														<else />
