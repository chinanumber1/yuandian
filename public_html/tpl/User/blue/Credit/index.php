 ...
 <div class="body pg-buy-process">
			...
			<div id="bd" class="cf">
				...
				<div id="content" class="coupons-box">
					<div class="mainbox mine">
						<div class="balance">您当前的余额： <strong>¥{pigcms{$now_user.now_money}</strong><if condition="$now_user.frozen_money gt 0 AND $now_user.free_time gt $_SERVER['REQUEST_TIME'] AND $config.open_frozen_money eq 1"><span class="frozen_money" style="font-size:12px;">(冻结{pigcms{$now_user.frozen_money|floatval}元)<i class="reason"></i></span></if> <a class="btn" id="recharge_amount">充值</a><if condition="$config.company_pay_open eq 1"> <if condition="$config.open_score_fenrun eq 1"><a class="btn" href="{pigcms{:U('fenrun_withdraw')}" id="fenrun_withdraw">提现</a><else /><a class="btn" href="javascript:void(0)" id="withdraw">提现</a></if></if></div>
						<ul class="filter cf">
	...
	<script>
		$(function(){
			...
			$('#fenrun_withdraw').live('click',function(){
