	...
	<div class="site-body pg-login cf">
	    ...
	    <div class="component-login-section component-login-section--page mt-component--booted" >
		    <div class="origin-part theme--www">
				...
				<if condition=" C('config.sms_key')"><p style="float: right;display:inline;" id="forgetpwd">忘记密码？<a href="#" onclick="$(this).attr('href','{pigcms{:U('Login/forgetpwd')}&accphone='+$('#login-phone').val());">点这里</a></p> </if>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#J-login-form").submit(function(){
				...
				$.post("{pigcms{:U('Index/Login/index')}", {'phone':phone, 'pwd':pwd<if condition="$config.international_phone eq 1">,'phone_country_type':$('#phone_country_type').val()</if>}, function(data){
					if (data.error_code) {
						$("#commit").val('登录').prop('disabled',false);
