<div class="header_top">
    <div class="hot cf">
        <div class="loginbar cf">
			...
			<if condition="$config['pcindex_show_appdown']">
				<div class="span">|</div>
				<div class="app cf">
					<div class="app_txt"><a href="{pigcms{$config.config_site_url}/topic/app.html" target="_blank"> APP版</a></div>
					<div class="app_icon"><p><span>|</span><a href="{pigcms{$config.config_site_url}/topic/app.html" target="_blank">访问APP版</a></p><img src="{pigcms{:U('Recognition/get_own_qrcode',array('qrCon'=>urlencode(C('config.site_url').'/topic/app_wap.html')))}"/></div>
				</div>
			</if>
        </div>
        <div class="list">
			...
			<ul class="cf">
				...
				<li class="li_shop">
					...
					<ul class="li_txt_info_ul cf">
						...
						<li><a class="dropdown-menu__item" rel="nofollow" href="{pigcms{$config.config_site_url}/store.php">店员中心</a></li>
						<if condition="$config['house_open']">
							<li><a class="dropdown-menu__item" rel="nofollow" href="{pigcms{$config.config_site_url}/shequ.php">社区管理</a></li>
						</if>
					</ul>
				</li>
			</ul>
