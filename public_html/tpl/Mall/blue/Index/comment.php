    ...
    <div class="details clearfix">
        ...
        <div class="detailsMassage pull-left">
            ...
            <div class="masDis clearfix">
                ...
                <ul class="pull-left">
                    ...
                    <li><i class="shou">首</i> 平台首单满{pigcms{$sn['money']}元减{pigcms{$sn['minus']}元</li>
                    </volist>
                    
                    <volist name="store['coupon_list']['system_minus']" id="sm">
                    <li><i class="jian1">减</i>平台优惠满{pigcms{$sm['money']}元减{pigcms{$sm['minus']}元</li>
                    </volist>
                    
                    <if condition="$store['coupon_list']['discount']">
                    <li><i class="zhe">折</i> 商家{pigcms{$store['coupon_list']['discount']}折优惠</li>
                    </if>
                    
                    <volist name="store['coupon_list']['newuser']" id="n">
                    <li><i class="shou2">首</i> 商家首单满{pigcms{$n['money']}元减{pigcms{$n['minus']}元</li>
                    </volist>
                    <volist name="store['coupon_list']['minus']" id="m">
                    <li><i class="hui">惠</i> 商家优惠满{pigcms{$m['money']}元减{pigcms{$m['minus']}元</li>
                    </volist>
                </ul>
            </div>
            </if>
            ...
            <div class="masColor clearfix spec" data-goods_id="{pigcms{$now_goods['goods_id']}">
                ...
                <ul class="clearfix spec_ul" data-id="{pigcms{$spec['id']}" data-name="{pigcms{$spec['name']}" data-num="1" data-type="spec">
                    ...
                    <li class="pull-left" data-id="{pigcms{$vo['id']}" data-name="{pigcms{$vo['name']}">{pigcms{$vo['name']}</li>
                    </volist>
                </ul>
            </div>
            </volist>
            ...
            <div class="masColor clearfix property">
                ...
                <ul class="clearfix properties_ul" data-id="{pigcms{$property['id']}" data-name="{pigcms{$property['name']}" data-num="{pigcms{$property['num']}" data-type="properties">
                    ...
                    <li class="pull-left" data-id="{pigcms{$pi}" data-name="{pigcms{$po}">{pigcms{$po}</li>
                    </volist>
                </ul>
            </div>
            </volist>
        ...
        <div class="contentLeft pull-left">
            ...
            <div class="goodUserheader clearfix">
                <div class=" pull-left ">
                    <ul class="clearfix">
                        <li class="pull-left te"><a href="/mall/goods/{pigcms{$now_goods['goods_id']}">商品</a></li>
            ...
            <div class="goodUser">
                <div class="userRat userShow" style="display:block;">
                    ...
                    <ul class="clearfix userRatHeader">
                        <li class="pull-left <if condition="$tab eq ''">active</if>"><a href="/mall/comment/{pigcms{$now_goods['goods_id']}">全部 ({pigcms{$all_count})</a></li>
                        <li class="pull-left <if condition="$tab eq 'high'">active</if>"><a href="/mall/comment/{pigcms{$now_goods['goods_id']}/high">满意 ({pigcms{$good_count})</a></li>
                        <li class="pull-left <if condition="$tab eq 'wrong'">active</if>"><a href="/mall/comment/{pigcms{$now_goods['goods_id']}/wrong">不满意 ({pigcms{$wrong_count})</a></li>
                    </ul>
                    <div class="xian"></div>
                    <!-- 评论列表-->
                    <div class="userRatList">
                        ...
                        <div class="ratItem">
                            <div class="ratItemLeft">
                                <img src="<if condition="empty($vo['avatar'])">{pigcms{$static_path}images/reply_user.png<else />{pigcms{$vo['avatar']}</if>"/>
                                <ul>
