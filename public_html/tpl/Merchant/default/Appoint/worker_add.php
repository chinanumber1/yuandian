						...
						<div class="tab-content">				
							<div id="basicinfo" class="tab-pane active">
                                ...
                                <div class="form-group" style="line-height: 35px;">
                                    ...
                                    <label style="padding-left:0px;padding-right:20px;"><input onclick="change(2)" type="radio" name="is_reward" value="2" class="ace"><span class="lbl" style="z-index: 1">开启</span></label>
                                    <label style="padding-left:0px;"><input onclick="change(1)" type="radio" name="is_reward" checked="checked" value="1" class="ace"><span class="lbl" style="z-index: 1">关闭</span></label>
                                    <label style="padding-left:10px;display: none;" id="reward_money_label"> <input placeholder="请输入打赏金额" onBlur="moneyChange(this)" size="20" name="reward_money" id="reward_money" type="text"/></label>
                                </div>
                               ...
                               <div class="form-group">
									...
									<input class="col-sm-2"  name="mobile" id="mobile" type="text"/>
								</div>
							...
							<div id="txtaccount" class="tab-pane">
								<div class="form-group">
									...
									<input class="col-sm-2" name="username" id="username" value="" type="text">
									 ...
									 <span class="form_tips red">&nbsp;*&nbsp;账号须为手机号</span>
