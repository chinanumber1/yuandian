						...
						<div class="tab-content">				
							...
							<div id="deliver" class="tab-pane">
								<div class="form-group">
									...
									<span><label><input id='deliver_type' name="deliver_type" <if condition="$store_meal['deliver_type'] eq 0 ">checked="checked"</if> value="0" type="radio"></label>&nbsp;<span>{pigcms{$config['deliver_name']}</span>&nbsp;</span>
