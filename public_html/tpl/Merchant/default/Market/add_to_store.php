	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			<li>
				...
				<a href="{pigcms{:U('Markt/index')}">进销存</a>
			</li>
			<li class="active"><a href="{pigcms{:U('Market/buy_order')}">进货订单例表</a></li>
						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane  active">
								...
								<div class="form-group">
									<label class="col-sm-1">店铺名称</label>
									<label class="col-sm-1">{pigcms{$now_store['name']}</label>
								</div>
								<div class="form-group">
