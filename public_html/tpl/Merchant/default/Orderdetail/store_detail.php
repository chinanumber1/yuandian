...
<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
	...
	<if condition="$order['ticketNum']">
		<tr>
			<th colspan="4">单张票价格：￥{pigcms{$order['ticketPrice']|floatval=###} 元</th>
		</tr>
		<tr>
			<th colspan="4">购票数量：{pigcms{$order['ticketNum']|floatval=###}</th>
		</tr>
		<if condition="floatval($order['ticketInsure'])">
			<tr>
				<th colspan="4">单张票保险价：￥{pigcms{$order['ticketInsure']|floatval=###} 元</th>
			</tr>
		</if>
	</if>
