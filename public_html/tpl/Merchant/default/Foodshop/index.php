...
<!-- 									<th class="button-column" width="140">店铺优惠</th> -->
									...
									<th class="button-column" width="140">导航管理</th>
									<th class="button-column" width="140">同步商品到{pigcms{$config['shop_alias_name']}店铺</th>
								</tr>
							</thead>
							<tbody>
...
<!-- 											<td></td> -->
											...
											<td class="button-column">
												<a style="width: 60px;" class="label label-sm label-info" title="导航管理" href="{pigcms{:U('Foodshop/store_slider', array('store_id'=>$vo['store_id']))}">导航管理</a>
											</td>
											
                                            <td class="button-column">
                                                <a style="width: 60px;" class="label label-sm label-info handle_btn" title="同步商品" href="{pigcms{:U('Foodshop/shop',array('store_id'=>$vo['store_id']))}">同步商品</a>
                                            </td>
											</if >
										</tr>
									</volist>
								<else/>
									<tr class="odd"><td class="button-column" colspan="12" >您没有添加店铺，或店铺没开启{pigcms{$config.meal_alias_name}功能，或店铺正在审核中。</td></tr>
								</if>
							</tbody>
						</table>
						{pigcms{$pagebar}
