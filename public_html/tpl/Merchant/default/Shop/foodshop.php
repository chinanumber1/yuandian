...
<body>
<form id="myform" method="post" action="{pigcms{:U('Shop/goodsToFood')}" enctype="multipart/form-data">
...
<tr><td></td><td style="float:right"><button type="submit">确定同步商品至{pigcms{$config['meal_alias_name']}店铺</button></td></tr>
</table>
</form>
</body>
</html>