						...
						<div class="grid-view">
							<form enctype="multipart/form-data" class="form-horizontal" method="post">
								<div class="form-group">
									...
									<input class="col-sm-1" size="10" name="full_money" id="full_money" type="text" value="{pigcms{$now_discount.full_money|default=''}"/>
									<span class="form_tips" style="color: red">满足条件的金额</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="sort">优惠的金额</label></label>
									<input class="col-sm-1" size="10" name="reduce_money" id="reduce_money" type="text" value="{pigcms{$now_discount.reduce_money|default=''}"/>
								...
								<div class="form-group">
									...
									<span><label><input name="is_share" value="1" checked="checked" type="radio">&nbsp;<span style="color: blue;">与限时优惠、店铺/分类折扣、会员优惠同享</span>&nbsp;</label></span>
									<span><label><input name="is_share" value="0" type="radio" >&nbsp;<span>与限时优惠、店铺/分类折扣、会员优惠不同享</span></label></span>
