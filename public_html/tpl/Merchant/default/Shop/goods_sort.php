	...
	<div class="page-content">
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="clearfix">
						<a class="btn btn-success" href="{pigcms{:U('Shop/sort_add',array('store_id' => $now_store['store_id'], 'fid' => $fid))}" style="float:left;">新建分类</a>
						<form action="{pigcms{:U('Shop/sort_goods_search')}" method="get" style="float:left;margin-left:10px">
							<input type="hidden" name="c" value="Shop"/>
							<input type="hidden" name="a" value="sort_goods_search"/>
							<input type="hidden" name="store_id" value="{pigcms{$now_store.store_id}"/>
							商品名称: <input type="text" name="keyword" class="input-text"/>
