		...
		<table>
			<tr>
				...
				<if condition="$now_user_adress">
					...
					<tr>
						<th width="15%">收货地址</th>
						<td width="85%" colspan="3">{pigcms{$now_user_adress.province_txt}&nbsp;{pigcms{$now_user_adress.city_txt}&nbsp;{pigcms{$now_user_adress.area_txt}&nbsp;{pigcms{$now_user_adress.adress}&nbsp;{pigcms{$now_user_adress.detail}</td>
					</tr>
				<else/>
					<tr>
