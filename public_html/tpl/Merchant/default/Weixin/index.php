						...
						<div class="tab-content">
                            ...
                            <div class="span12" style="margin-top:10px;">
                                <div class="form-actions1">
                                    <a class="btn btn-error cert-setting-btn" id="cancelBind">解除绑定</a>
                                </div>
                            </div>
						</div>
					</form>
...
$(document).ready(function(){
    $('#cancelBind').click(function(){
        layer.confirm('您确定要解除该公众号的绑定吗？', {
            btn: ['解除绑定','取消'] //按钮
        }, function(){
            $.post('merchant.php?g=Merchant&c=Weixin&a=cancelBind',function(response){
