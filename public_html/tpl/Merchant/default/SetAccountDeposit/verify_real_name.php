...
<div class="main-content">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
			...
			<li class="active"><a href="{pigcms{:U('SetAccountDeposit/verify_real_name')}">实名认证</a></li>
        </ul>
    </div>
            ...
            <div class="row">
                <div class="col-xs-12">
					<form class="form" method="post" action="" target="_top" enctype="multipart/form-data">
						<label for="tab1" class="select_tab select" style="cursor:pointer;">实名认证</label>
						...
						<div class="tab-content card_new" id="tab1" >
							...
							<div class="form-group">
								...
								<input id="name" class="px" type="text" placeholder="真实姓名" name="name" value="" style="width:210px;"/>
								<span class="tip"></span>
								
							</div>
							<div class="form-group">
								<label class="tiplabel"><label><font color="red">*</font>验证码</label></label>
								<input id="identityNo" class="px" type="tel" placeholder="身份证号码" name="identityNo" value="" style="width:210px;"/><span class="tip"></span>
