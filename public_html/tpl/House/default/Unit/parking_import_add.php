    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="{pigcms{:U('parking_management')}">车位管理</a>
            </li>
            <li class="active">导入车位</li>
        </ul>
    </div>
    <!-- 内容头部 -->
                ...
                <div class="col-xs-12">
                    ...
                    <form id="myform" method="post" action="__SELF__" enctype="multipart/form-data">
						<table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover" width="100%">
							<tr>
								<th width="80">示例表格</th>
								<td><a target="_blank" href="{pigcms{$static_public}file/village_import_parking_add.xls" class="button" style="margin-left:0px;">点击下载</a></td>
							</tr>
							<tr>
