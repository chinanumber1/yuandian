...
<div class="main-content">
                        ...
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <label onclick="pay_type(1)" style="padding-left:0px;padding-right:20px;"><input type="radio" checked="" class="ace" value="1" name="pay_type"><span style="z-index: 1" class="lbl">固定费用</span></label>
                                    <label onclick="pay_type(2)" style="padding-left:0px;"><input type="radio" class="ace" value="2" name="pay_type"><span style="z-index: 1" class="lbl">按单价*数量</span></label>
                                </div>
                                <script>
 ...
 -->
                                ...
                                <div class="form-group metering_mode" style="display: none;">
                                    <label class="col-sm-1">计量方式</label>
                                    <label onclick="metering_mode_type(1)" style="padding-left:0px;padding-right:20px;"><input type="radio" checked="" class="ace" value="1" name="metering_mode_type"><span style="z-index: 1" class="lbl">房间面积</span></label>
                                    <label onclick="metering_mode_type(2)" style="padding-left:0px;">
                                    <input type="radio" class="ace" value="2" name="metering_mode_type">
                                    <span style="z-index: 1" class="lbl">自定义&nbsp;<input type="text" name="metering_mode" id="metering_mode" placeholder="例：车库面积" style="width: 150px; display: none;"></span>
                                    </label>
                                </div>
