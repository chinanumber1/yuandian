						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								...
								<!-- <div class="form-group">
									<label class="col-sm-1"><label for="property_id">物业名称</label></label>
									<select name="property_id" id="property_id">
										<option value='0'>--请选择--</option>
										<volist name='info_list' id="vo">
										<option value='{pigcms{$vo.property_id}'>{pigcms{$vo.property_name}</option>
										</volist>
									</select>
								</div> -->
								...
								<div class="form-group">
									...
									<input class="col-sm-2" size="20" name="garage_position" id="garage_position" type="text"  value="" />
								</div>
								
								<div class="form-group">
									<label class="col-sm-1"><label>备注</label></label>
									<label><textarea name="garage_remark" id="garage_remark" maxlength="255" style="width:286px;height:90px;resize:none" placeholder="最多输入255个字"></textarea></label>
								</div>
...
$('.submit_info').click(function(){
	...
	$.post("{pigcms{:U('garage_add')}",{'garage_num':garage_num,'garage_position':garage_position,'garage_remark':garage_remark},function(data){
                if(data.code == 1){
