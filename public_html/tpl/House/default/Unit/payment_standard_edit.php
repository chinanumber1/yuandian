    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="{pigcms{:U('Unit/payment_item')}">自定义收费</a>
            </li>
                        ...
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <label onclick="pay_type(1)" style="padding-left:0px;padding-right:20px;"><input type="radio" <if condition="$info.pay_type eq 1">checked="checked"</if>  class="ace" value="1" name="pay_type"><span style="z-index: 1" class="lbl">固定费用</span></label>
                                    <label onclick="pay_type(2)" style="padding-left:0px;"><input type="radio" <if condition="$info.pay_type eq 2">checked="checked"</if> class="ace" value="2" name="pay_type"><span style="z-index: 1" class="lbl">按单价*数量</span></label>
                                </div>
                                <script>
                                ...
                                <div class="form-group metering_mode" <if condition="$info.pay_type eq '1'"> style="display: none;"<else/>style="display: block;"</if>>
                                    ...
                                    <label onclick="metering_mode_type(1)" style="padding-left:0px;padding-right:20px;">
                                        <input  type="radio" checked="" class="ace" value="1" name="metering_mode_type" <if condition="$info.metering_mode_type eq 1">checked="checked"</if>>
                                        <span style="z-index: 1" class="lbl">房间面积</span>
                                    </label>

                                    <label onclick="metering_mode_type(2)" style="padding-left:0px;">
                                        <input type="radio" class="ace" value="2" name="metering_mode_type" <if condition="$info.metering_mode_type eq 2">checked="checked"</if>>
                                        <span style="z-index: 1" class="lbl">自定义&nbsp;<input type="text" name="metering_mode" id="metering_mode" value="{pigcms{$info.metering_mode}" placeholder="例：车库面积" <if condition="$info.metering_mode_type eq '1'"> style="display: none;"</if> ></span>
                                    </label>

                                </div>

                                <script>
                                    function metering_mode_type(type){
                                        if(type == 1){
                                            $("#metering_mode").css('display','none');
                                        }else{
                                ...
                                <script>
                                    KindEditor.ready(function(K) {
                                        ...
                                        K('#image3').click(function() {
                                            editor.uploadJson = "{pigcms{:U('Unit/ajax_upload_pic')}";
