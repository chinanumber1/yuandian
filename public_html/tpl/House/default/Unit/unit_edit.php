						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								...
								<div class="form-group">
                                 ...
                                 <div class="form-group">
									...
									<input size="6" name="water_fee" id="water_fee" type="text" value="{pigcms{$detail.water_fee}"/>
									&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">单位：元 / 立方米</span>
									&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">*可不填写</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="electric_fee">电费</label></label>
									<input size="6" name="electric_fee" id="electric_fee" type="text" value="{pigcms{$detail.electric_fee}"/>
									&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">单位：元 / 千瓦时(度)</span>
									&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">*可不填写</span>
								</div>
                                <div class="form-group">
									<label class="col-sm-1"><label for="gas_fee">燃气费</label></label>
									<input size="6" name="gas_fee" id="gas_fee" type="text" value="{pigcms{$detail.gas_fee}"/>
									&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">单位：元 / 立方米</span>
									&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">*可不填写</span>
								</div>
                                <div class="form-group">
									<label class="col-sm-1"><label for="parking_fee">停车费</label></label>
									<input size="6" name="parking_fee" id="parking_fee" type="text" value="{pigcms{$detail.parking_fee}"/>
							...
							<if condition="$config['PC_write_card'] eq 1">
								<div class="form-group">
									...
									<input size="15" name="door_control" onkeyup="value=value.replace(/[^\\d,]/g,'')" id="door_control" type="text" value="{pigcms{$detail.door_control}"/>
						...
						<div class="space"></div>
							<div class="clearfix form-actions">
								<div class="col-md-offset-3 col-md-9">
            						<if condition="in_array(22,$house_session['menus'])">
