...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="myform" action="{pigcms{:U('position_payment_add')}" method='post'>
			<table>
				<tr>
					<th width="15%">收费项目</th>
					<td width="85%">
				...
				<script>
					$("#payment").on("change",function(){
						...
						var payment_standard_choice_url = "{pigcms{:U('User/payment_standard_choice')}"; 
						$.post(payment_standard_choice_url,{'payment_id':payment_id,'bind_type':'2'},function(data){
							// alert(data.data)
				...
				<input type="hidden" name="position_id" value="{pigcms{$_GET['position_id']}"/>
