							...
							<div id="basicinfo" class="tab-pane active">
                                ...
                                <div class="form-group">
									<label class="col-sm-1">是否可以重复报名</label>
										<label style="padding-left:0px;padding-right:20px;"><input type="radio" checked="" class="ace" value="1" name="is_repeat_join"><span style="z-index: 1" class="lbl">是</span></label>
										<label style="padding-left:0px;"><input type="radio" class="ace" value="0" name="is_repeat_join"><span style="z-index: 1" class="lbl">否</span></label>
								</div>
							</div>
						</div>
