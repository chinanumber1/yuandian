	...
	<div class="page-content">
        <div class="page-content-area">
            ...
            <div class="row">
                ...
                <else />
                	<button class="btn btn-success" onclick="activity_add()" <if condition="!in_array(233,$house_session['menus'])">disabled="disabled"</if>>添加社区活动</button>
            	</if>
                                    ...
                                    <volist name="list['list']" id="vo">
                                        <tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
                                            ...
                                            <else />
											 ...
											 <td><div class="tagDiv">
                                            <if condition='$vo["is_repeat_join"] eq 0'>
                                            ...
                                            <td class="button-column">
                                                <if condition="in_array(236,$house_session['menus'])">
                                                ...
                                                <if condition="in_array(235,$house_session['menus'])">
