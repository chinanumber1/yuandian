...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="page-content-area">
        	<button class="btn btn-success" onclick="importAdd()" <if condition="!in_array(76,$house_session['menus'])">disabled="disabled"</if>>添加收费标准</button>
            <style>
                                    ...
                                    <volist name="standard_list" id="vo">
                                        <tr>
                                            ...
                                            <td class="button-column">
                                                ...
                                                <if condition="in_array(78,$house_session['menus'])">
