						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									...
									<input class="col-sm-2" size="20" name="payment_name" id="payment_name" type="text" value="{pigcms{$info.payment_name}"/>
									<input type="hidden" name="payment_id" value="{pigcms{$info.payment_id}">
								</div>
							</div>
						</div>
						<div class="space"></div>
							<div class="clearfix form-actions">
								<div class="col-md-offset-3 col-md-9">
                                    <if condition="in_array(73,$house_session['menus'])">
