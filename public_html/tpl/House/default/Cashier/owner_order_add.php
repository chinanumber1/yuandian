		...
		<div class="page-content-area">
			<div class="row">
				<div class="col-xs-12">
					...
					<form  class="form-horizontal" method="post" onSubmit="return check_submit()" action="{pigcms{:U('owner_order_add')}" frame="true" refresh="true">
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									...
									<label class="col-sm-1">
										<select name="type" id="type">
											...
											<option value="custom">临时费用</option>
											
										</select>
										<!-- <label id="custom_name" style="display:none">缴费名称：<input type="text"  value="" name="custom_remark"></label> -->
									</label>
									<label class="col-sm-2 property_desc red" style="    margin-left: 70px;"></label>
								</div>
								<div class="form-group" id="custom_name" style="display:none">
									<label class="col-sm-1"><label for="custom_remark">缴费名称</label></label>
									<label class="col-sm-1">
										<input type="text" value="" name="custom_remark">
									</label>
								</div>
								...
								<!-- <div class="form-group  ">
									...
									<label class="col-sm-1">
										<input type="text" placeholder="请输入业主物业编号" name="usernum" id="usernum" value="{pigcms{$user_info.usernum}" />
									</label>
								</div> -->
								<input type="hidden" placeholder="请输入业主物业编号" name="usernum" id="usernum" value="{pigcms{$user_info.usernum}" />
							</div>
...
$(function(){
	...
	$('#usernum').keyup(function(){
		...
		get_user_list(usernum)
	});
})

function get_user_list(usernum){
...
get_user_list('{pigcms{$user_info.usernum}');
...
var ajax_property_info_url = "{pigcms{:U('Library/ajax_property_info')}"
