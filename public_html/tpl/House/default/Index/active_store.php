...
<div class="main-content">
	...
	<div class="page-content">
		<div class="page-content-area">
			<div class="row">
				<div class="col-xs-12">
					<form enctype="multipart/form-data" class="form-horizontal" method="post" action="{pigcms{:U('Index/active_store')}" onsubmit="return doSub();">
						<input type="hidden" name="store_id" id="store_id"/>
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									<label class="col-sm-1"><label for="title">快店网址</label></label>
									<input class="col-sm-2" size="80" name="url" id="store_url" type="text" value=""/>&nbsp;&nbsp;
...
function checkGroup(){
	...
	if(check_url.indexOf('wap.php')>0){
		...
		if(!store_id){
			var urlArr = check_url.split('#shop-');
			if(urlArr.length > 1){
				store_id = urlArr[1];
			}
		}
