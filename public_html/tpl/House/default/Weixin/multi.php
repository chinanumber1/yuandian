	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			<li>
				...
				<a href="{pigcms{:U('Weixin/article')}">图文素材</a>
			</li>
			<li>创建多图文</li>
		</ul>
	</div>
							...
							<form enctype="multipart/form-data" class="form-horizontal" method="post">
								<table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
									<tbody>
										...
										<tr>
											<th></th>
											<td><button type="submit" class="btn btn-info" onclick="return submit_check();" <if condition="!in_array(191,$house_session['menus']) && !in_array(192,$house_session['menus'])">disabled="disabled"</if>>保存</button>　<a href="javascript:history.go(-1);" class="btnGray vm">取消</a></td>
										</tr>
									</tbody>
								</table>
							</form>
