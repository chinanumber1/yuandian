							...
							<div class="form">
								<form class="well" id="food-form" action="" method="post">
									...
									<div class="form-actions">
										<button class="btn btn-info" type="submit" <if condition="!in_array(188,$house_session['menus'])">disabled="disabled"</if>><i class="ace-icon fa fa-check bigger-110"></i> 提交</button>
									</div>
								</form>
							</div>
							<!-- form -->
