							...
							<form enctype="multipart/form-data" class="form-horizontal" method="post">
								...
								<div class="clearfix form-actions">
									<div class="col-md-offset-3 col-md-9">
										<button class="btn btn-info" type="submit" onclick="return submit_check();" <if condition="!in_array(191,$house_session['menus']) && !in_array(192,$house_session['menus'])">disabled="disabled"</if>>
