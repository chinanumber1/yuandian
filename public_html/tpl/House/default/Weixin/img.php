				...
				<div class="col-xs-12">
					<div class="tabbable">
						<ul class="nav nav-tabs" id="myTab">
							...
							<div>
							<if condition="in_array(187,$house_session['menus'])">
							<a href="{pigcms{:U('Weixin/reply_img')}" class="btn btn-success">新建图文回复</a>
							<else/>
							<button type="button" class="btn btn-success" disabled="disabled">新建图文回复</button>
							</if>
							</div>
									...
									<volist name="lists" id="vo">
										<tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
											...
											<td nowrap="nowrap" class="center">
												...
												<if condition="in_array(189,$house_session['menus'])">
