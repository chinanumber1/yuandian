								...
								<div id="txtimage" class="tab-pane">
									...
									<div class="form-group">
										...
										<div id="upload_pic_box">
											<ul id="upload_pic_ul">
                                            	<if condition="$aBbs['index_icon']">
												<li class="upload_pic_li"><img style="width:100px;height:100px;" src="{pigcms{$aBbs['index_icon']}"/><input type="hidden" name="pic" id="pic_up" value="{pigcms{$aBbs['index_icon']}"/><br/><a href="#" onclick="deleteImg(1,this);return false;">[ 删除 ]</a></li></if>
			...
			editor.loadPlugin('image', function(){
				editor.plugin.imageDialog({
					...
					clickFn : function(url, title, width, height, border, align) {
						$('#upload_pic_ul').append('<li class="upload_pic_li"><img src="'+url+'"/><input type="hidden" name="pic" id="pic_up" value="'+url+'"/><br/><a href="#" onclick="deleteImg(\''+title+'\',this);return false;">[ 删除 ]</a></li>');
						editor.hideDialog();
					}
				});
			});
