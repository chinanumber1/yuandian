...
function insertEmot(e,forid){
	...
	if($('#'+fid)[0]){
		...
		var tipsEmotHTML = '<div class="'+tipsEmotid+'" id="'+tipsEmotid+'"><img id="'+tipsEmotid+'_src" src="/portal/default/static/activity/images/24x24tranparent.gif" /><span class="alt" id="'+tipsEmotid+'_alt"></span/></div>';
...
function loadEmot(fid,forid,left,top){
	...
	var i=0,k=0,len=emotData.length,path='/portal/default/static/activity/images/',imgsrc='',sourceImgsrc='';
	for( ;i<len;i++){
