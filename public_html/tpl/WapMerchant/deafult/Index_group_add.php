...
<body>
	...
	<div class="container container-fill" style='padding-top:50px'>
		...
		<form class="pigcms-form" method="post" action="{pigcms{:U('Index/group_add')}" id="add_form">
	      ...
	      <div id="relpackages" style="border:1px solid #c5d0dc;padding:0px 0px 10px 10px;margin-bottom:10px;border-top:none;">
			...
			<button type="button" class="pigcms-btn-block pigcms-btn-block-info" id="save_btn" value="添加">添加</button>
