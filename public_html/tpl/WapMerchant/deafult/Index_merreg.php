...
<body>
	...
	<form class="pigcms-form" method="post" action="" onsubmit="return checkSubmit();return false;">
		...
		<div class="pigcms-container">
			<p class='pigcms-form-title'>推广码：</p>
			<input type="text" class="pigcms-input-block" name="spread_code" placeholder="从推荐人处获取">
		</div>
		</if>
		...
		<div class="pigcms-container">
			...
			<input type="text" class="pigcms-input-block" name="email" placeholder="非必填"/>
		</div>
		<div class="pigcms-container">
	  ...
	  <div class="pigcms-container">
		...
		<if condition="$config.merchant_verify eq 1"><p class="form_tips">注册成功后需要管理员审核！</p></if>
