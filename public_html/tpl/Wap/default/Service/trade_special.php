...
<div class="pagewrap" id="mainpage">
    ...
    <div class="main padd-wrap1" style="padding-bottom: 80px;">
        <!-- 措施机会不显示 -->
        <div class="status-list-wrap "  >
            <form id="service-publish-form">
                <ul class="status-list">
                    <li class="status_li" style="width: 25%;"> <a href="{pigcms{:U('Service/trade_special')}" class="current">跑腿需求</a> </li>
        ...
        <div >
                                ...
                                <dd>
                                    <div class="sm-li2">
                                        <span class="con-txt1">
                                            ...
                                            <span class="small">配送员</span>
                                        </span>
                                        <if condition="$vo.catgory_type eq 2">
            ...
            <else/>
                <div class="no_record service_no_record">
                    <div class="no_record_con">暂无此项内容……</div>
                </div>
            </if>
        </div>
    </div>
...
<!-- 筛选弹出层 -->
<div id="filter_tpl_pop" class="hidden">
