					...
					<if condition="$group_list">
		    			<dl class="list list-in">
		       				<volist name="group_list" id="vo">
			        			<dd>
			        				<a href="{pigcms{:U('Group/detail',array('pin_num'=>$vo['pin_num'],'group_id'=>$vo['group_id']))}" class="react" style="padding: .28rem 0.2rem 0.55rem 0.2rem;">
										<div class="dealcard">
											<div class="dealcard-img imgbox" style="background:white;">
												<img src="{pigcms{$vo.list_pic}" style="width:100%;"/>
											</div>
										    <div class="dealcard-block-right">
												...
												<if condition="isset($group_around_range[$vo['group_id']])">
													<div class="location_list" style="top: 80px;">约<em>{pigcms{:round($group_around_range[$vo['group_id']]/1000,1)}</em>km</div>
												</if>
										    </div>							    
										</div>
			       					</a>
