...
.top_bar .top_menu>li.home a { height: 60px; width: 60px; margin: auto; border-radius: 60px; position: relative; top: -14px; background: url('tpl/Wap/default/static/images/home.png') no-repeat center center; background-size: 100% 100%; }
