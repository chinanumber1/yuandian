    ...
    SelectChar.prototype = {
        ...
        show:function(){
            ...
            for(var i = 0;i<this.charslength;i++){
                cnt += '<div style="width: 100%;height:'+this.everyCharHeight+'px;line-height:'+this.everyCharHeight+'px;text-align: center;font-size: 10px;color: #666;">'+this.options.chars[i]+'</div>';
            }
            cnt == '</div></section>';
