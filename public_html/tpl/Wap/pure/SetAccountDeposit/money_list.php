						...
						if(result){
							...
							if(ride_list){
								...
								for(var x=0;x<ride_list_length;x++){
									...
									rideList	+=	'	<div style="float:left;width:70%;">'+ride_list[x].accountSetName+'</div>';
									if(ride_list[x].chgAmount <0){
										rideList	+=	'	<div style="float:right;width:30%;text-align:right;">￥'+(ride_list[x].chgAmount/100)+'</div>';
									}else{
										rideList	+=	'	<div style="float:right;width:30%;text-align:right;color:#e50000">￥'+(ride_list[x].chgAmount/100)+'</div>';
									}
									rideList	+=	'	<div style="clear:both;"></div>';
									rideList	+=	'	<div style="color:#bbb;font-size:12px;">'+ride_list[x].changeTime+'</div>';
									rideList	+=	'</div>';
								}
