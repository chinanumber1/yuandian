				...
				<script type="text/javascript">
					$(function(){
                        if(typeof(is_google_map) != "undefined"){
                           var lng = parseFloat({pigcms{$now_store.long});
                           var lat = parseFloat({pigcms{$now_store.lat});
                           var secretMessage = "{pigcms{$now_store.name}";
                            ...
                            attachSecretMessage(marker, decodeURIComponent(secretMessage));
