...
<html lang="zh-CN">
	<head>
		<meta charset="utf-8" />
		<title>推荐{pigcms{$config.shop_alias_name}</title>
	...
	<body>
		...
		<div id="pageCat" class="pageDiv">
			<section id="catHeader">
				...
				<span id="catTitle" data-text="推荐{pigcms{$config.shop_alias_name}">分类</span>
			</section>
