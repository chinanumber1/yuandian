...
<html lang="zh-CN">
	<head>
		...
		<script type="text/javascript">var indexUrl="<if condition="$url">{pigcms{$url}<else />{pigcms{:U('Home/index')}</if>";var cityTopDomain=".{pigcms{$config.many_city_top_domain}";var get_wxapp="{pigcms{:intval($_GET['wxapp'])}";</script>
