...
<html lang="zh-CN">
	...
	<body>
		...
		<section class="searchBox pageSliderHide">
			<ul>
				<if condition="$config.appoint_alias_name neq ''"><li class="dropdown-toggle active" data-url="{pigcms{:U('Search/appoint',array('w'=>urlencode($keywords)))}"  data-url-type="openLeftWindow"><span class="nav-head-name">{pigcms{$config.appoint_alias_name}</span></li></if>
