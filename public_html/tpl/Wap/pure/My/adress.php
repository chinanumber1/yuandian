...
<body id="index">
        ...
        <php>if ($out_adress_list) { </php>
		<div class="listceng">	
			<h3>以下地址超出配送范围</h3>
            <volist name="out_adress_list" id="vo">
			<dl class="list ">
		        <dd class="address-wrapper dd-padding" style="position:relative;">
                    <a class="react" style="padding:0;padding-right:30px;">
		...
		<script>
			...
			$('#top-plus').click(function(){
				var url = "{pigcms{:U('edit_adress',$_GET)}";
				location.href = url;
			});
		</script>
{pigcms{$hideScript}
