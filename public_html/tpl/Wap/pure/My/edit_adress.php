		    ...
		    <dl class="list list-in">
		    	<dd>
		    		<dl style="padding-right:.2rem;">
		        		...
		        		<dd class="dd-padding kv-line">
		        			<h6>区号</h6>
								<select name="phone_country_type" id="phone_country_type">
								<option value="86" <if condition="$now_adress.phone_country_type eq 86">selected</if>>+86 中国 China</option>
								<option value="1" <if condition="$now_adress.phone_country_type eq 1">selected</if>>+1 加拿大 Canada</option>
