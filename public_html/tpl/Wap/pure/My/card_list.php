									...
									<dl class="Muse">
										<dd>
											<div class="Coupon_top clr">
												<div class="fl">
													<div class="fltop" <if condition="$vo.is_discount eq 1">style="text-align:center" </if>>
														<if condition="$vo.is_discount eq 1">{pigcms{$vo.discount_value|floatval}折<else /><i>￥</i><em>{pigcms{$vo.discount}</em></if>
														
													</div>
													<div class="flend">
													<if condition="$vo.is_discount eq 1">
														<php>if($vo['order_money']>0){</php>满{pigcms{:floatval($vo['order_money'])}打<php>}</php>{pigcms{$vo.discount-value|floatval}折
													<else />
										...
										<dd>
											<div class="Coupon_top clr">
												<div class="fl">
													...
													<div class="flend">
													<if condition="$vo.is_discount eq 1">
														<php>if($vo['order_money']>0){</php>满{pigcms{:floatval($vo['order_money'])}打<php>}</php>打{pigcms{$vo.discount-value|floatval}折
													<else />
														满{pigcms{:floatval($vo['order_money'])}减{pigcms{$vo.discount}
													</if>
													</div>
