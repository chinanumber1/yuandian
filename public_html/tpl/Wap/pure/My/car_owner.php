...
<div class="Guide_end">
	...
	<div class="Correctid" style="display:none">
		<dl class="scwj clr">
			<dd>
				<ul class="clearfix">
					<li>
				...
				<span>{pigcms{$config.ride_upload_pic_name_3}</span>
			</dd>
			<dd>
				<ul class="clearfix">
					<li>
				...
				<span>{pigcms{$config.ride_upload_pic_name_4}</span>
			</dd>
	...
	<div class="Correctid">
		...
		<p class="jszt">{pigcms{$config.ride_upload_pic_name_1}</p>
	</div>
	<div class="Correctid">
		<img src="{pigcms{$find['driving_license']}" width=100% height=0>
		<p class="jszt">{pigcms{$config.ride_upload_pic_name_2}</p>
	</div>
	<div class="Correctid">
		<img src="{pigcms{$find['authentication_img']}" width=100% height=0>
		<p class="jszt">{pigcms{$config.ride_upload_pic_name_3}</p>
	</div>
	<div class="Correctid">
		<img src="{pigcms{$find['authentication_back_img']}" width=100% height=0>
		<p class="jszt">{pigcms{$config.ride_upload_pic_name_4}</p>
	</div>
</div>
