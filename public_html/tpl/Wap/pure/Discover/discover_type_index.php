...
<body onload="loaded()">
<header class="pageSliderHide"><div id="backBtn"></div>{pigcms{$categoryInfo.type_name}<div id="plus"><img src="{pigcms{$static_path}images/new_my/recharge.png"></div></header>
...
<script type="text/javascript">
    ...
    $('#plus').click(function(){
        location.href = "{pigcms{:U('add_discover_msg',array('type_id'=>$_GET['type_id']))}"
    });
</script>
