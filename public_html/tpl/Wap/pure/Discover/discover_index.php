...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="{pigcms{$static_path}css/discover.css?003" />
        <style>
            #carousel{
                width: 100%;
                height: 55px;
	...
	<body onload="loaded()">
        ...
        <div style="display: none;" id="searchBtn" class="listSearchBtn page-link" data-url="shopSearch"><div></div></div>
		<div id="container">
            <div class="content-padded grid-demo discover-type-title" id="scroller-content">
                <div class="content-top">
                    <div id="carousel">
                        <ul style="height: 55px;">
                            ...
                            <if condition='$discover_category'>
                                <volist name='discover_category' id='category_info'>
                                    <li>
                                        <a  style="color: #999;" href="{pigcms{:U('discover_type_index',array('type_id'=>$category_info['type_id']))}">
                                            <p>{pigcms{$category_info.type_name}</p>
                                        </a>
                                    </li>
                                </volist>
                            </if>
			...
			<div id="wrapper">
				<div id="scroller" class="village_my">
					...
					<ul class="bbs-list discover_top">
											...
											<div class="bbs-image">
												<ul>
													<volist name='dml["discover_img"]' id='img'>
                                                        <li style="height: 86px; background: url('{pigcms{$img}') center center / cover;"></li>
													</volist>
												</ul>
											</div>
										</div>
...
<!--                                    </div>-->
                                    <div class="discover-collect-box">
                                        ...
                                        <p class="user_collect discover-collect" <if condition="$dml['collection']">style="color:#06c1ae"</if>  data-collection="{pigcms{$dml.collection}" data-discover_id="{pigcms{$dml.discover_id}">
                                            <if condition="$dml['collection']">
                                                <img class="collect_img" src="{pigcms{$static_path}discover/images/icon/ft4_a.png?t=001?t=001" />
                                                <else/>
		...
		<script type="text/javascript">
			...
			function loaded() {
				...
				var discover_index_json_url = "{pigcms{:U('discover_index_json')}";
