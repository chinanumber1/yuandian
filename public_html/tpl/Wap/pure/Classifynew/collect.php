...
<body>
	...
	<div class="page__bd hong">	
		...
		<div class="weui-navbar mt0">
			<a href="javascript:void(0);" class="weui-navbar__item weui_bar__item_on">
				<span>收藏</span>
			</a>
		</div>
	...
	<div class="weui-tabbar">
		...
		<a href="{pigcms{:U('fabu')}" class="weui-tabbar__item showpubfont">
        ...
        <a href="{pigcms{:U('collect')}" class="weui-tabbar__item weui-bar__item_on">
	...
	<include file="footer"/>
	<script>
		var loadingurl = "{pigcms{:U('getList',array('type'=>'collect'))}&page=";
	</script>
</body>
</html>