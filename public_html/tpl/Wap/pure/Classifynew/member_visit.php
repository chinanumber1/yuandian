...
<body>
	...
	<div class="page__bd hong">	
		...
		<div class="weui-navbar mt0">
			<a href="{pigcms{:U('member',array('uid'=>$nowUser['uid']))}" class="weui-navbar__item">
				<span>发布</span>
			</a>
			<a href="{pigcms{:U('member_visit',array('uid'=>$nowUser['uid']))}" class="weui-navbar__item weui_bar__item_on">
				<span>访客</span>
			</a>
		</div>
	...
	<include file="footer"/>
	<script>
		var loadingurl = "{pigcms{:U('getMemberVisitList',array('uid'=>$nowUser['uid']))}&page=";
	</script>
</body>
</html>