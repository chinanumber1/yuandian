<include file="Public:header"/>
	<form id="myform" method="post" action="{pigcms{:U('Shop/add_shop_center_type_img')}" enctype="multipart/form-data" ">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				...
				<em tips="纯图片模式下建议尺寸：
				 建议尺寸：【3图模式】，第一张图280*270
，第二、第三张图均是280*135。【4图模式】，四张图均是350*240。【5图模式】，第一、第二张图均是350 *240 ，第三、第四、第五张图均是230*260。" class="notice_tips"></em></td>
			</tr>
			<tr>
				<th width="80">链接地址</th>
				<td>
