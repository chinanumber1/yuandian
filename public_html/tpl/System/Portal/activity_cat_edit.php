<include file="Public:header"/>
	<form id="myform" method="post" action="{pigcms{:U('Portal/activity_cat_edit')}" enctype="multipart/form-data" frame="true" refresh="true">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				<th width="80">分类图片</th>
				<td><input type="text" class="input fl" readonly="readonly" name="img" value="{pigcms{$now_category.img}" id="listImg" placeholder="图片地址" style=" width: 300px;"><a href="javascript:void(0)" class="button" id="image3">浏览</a></td>
			</tr>
			...
			<script>
		        KindEditor.ready(function(K) {
		            ...
		            K('#image3').click(function() {
		                editor.uploadJson = "{pigcms{:U('Portal/ajax_upload_pic')}";
