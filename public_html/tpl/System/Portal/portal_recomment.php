					...
					<table width="100%" cellspacing="0">
						<thead>
							<tr>
								...
								<th class="textcenter"><if condition="$_GET['type'] eq 0">资讯<else/>活动</if>ID</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="textcenter">{pigcms{$vo.target_id}</td>
								...
								<td class="textcenter"><a href="javascript:void(0);" class="delete_row" parameter="id={pigcms{$vo.id}" url="{pigcms{:U('Portal/comment_del')}">删除</a></td>
							</tr>
							</volist>
