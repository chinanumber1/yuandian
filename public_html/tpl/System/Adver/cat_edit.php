<include file="Public:header"/>
	<form id="myform" method="post" action="{pigcms{:U('Adver/cat_amend')}" frame="true" refresh="true">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				<th width="80">分类标识</th>
				<td><input type="text" class="input fl" name="cat_key" value="{pigcms{$now_category.cat_key}" size="20" placeholder="分类标识" validate="maxlength:50,required:true" tips="如果是团购分类头部展示的广告，请填写<br/> cat_(分类ID)_top"/></td>
			</tr>
			<tr>
				<th width="80">建议尺寸</th>
				<td><textarea name="size_info" rows="4" cols="30" placeholder="广告位的建议尺寸" validate="maxlength:50,required:true">{pigcms{$now_category.size_info}</textarea></td>
			</tr>
			<tr>
				<th width="80">分类类型</th>
				<td>
