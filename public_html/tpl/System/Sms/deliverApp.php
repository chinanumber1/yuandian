    ...
    <form method="post" action="{pigcms{:U('System/Sms/deliverApp')}">
        <table cellpadding="0" cellspacing="0" class="table_form" width="100%" style="" >
			...
			<tr>
                ...
                <td>
                   <input type="text" class="input-text" name="android_package_name" id="deliver_android_package_name" value="{pigcms{$deliver_android_package_name}" size="60" validate="required:true" tips="请填写当前Android包名："/>
                </td>
            </tr>
			<tr>
                <th width="160">Android版本名称：</th>
                <td>
                    <input type="text" class="input-text" name="android_version_code" id="deliver_android_version_code" value="{pigcms{$deliver_android_vcode}" size="60" validate="required:true" tips="请填写当前Android版本名称"/>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="input-text" name="android_version" id="deliver_android_version" value="{pigcms{$deliver_android_version}" size="60" validate="required:true,number:true" tips="请填写当前Android版本号"/>
					<span>版本号，数字 格式</span>
                </td>
            </tr>
            <tr>
