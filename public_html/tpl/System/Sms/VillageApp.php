...
<div class="mainbox">
    <div id="nav" class="mainnav_title">
		<ul>
			...
			<a href="{pigcms{:U('Sms/VillageApp')}"class="on" >社区APP版本配置</a>
			<a href="{pigcms{:U('Sms/VillageManergeApp')}">社区管理APP版本配置</a>	
		</ul>
	</div>
    <form method="post" action="{pigcms{:U('System/Sms/villageApp')}">
        <table cellpadding="0" cellspacing="0" class="table_form" width="100%" style="" >
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="input-text" name="android_version" id="village_android_version" value="{pigcms{$village_android_v}" size="60" validate="required:true" tips="请填写当前Android版本名称"/>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="input-text" name="android_version_code" id="village_android_version_code" value="{pigcms{$village_android_vcode}" size="60" validate="required:true" tips="请填写当前Android版本号"/>
					<span>版本号，数字 格式</span>
                </td>
            </tr>
            <tr>
                <th width="160">Android版本描述：</th>
                <td><textarea name="android_version_desc" style="width:480px;height:160px;" id="village_android_version_desc">{pigcms{$village_android_vdesc}</textarea></td>
            </tr>
            <tr>
                <th width="160">Android下载地址：</th>
                <td><!--validate="required:true"-->
                    <input type="text" class="input-text" name="android_download_url" id="village_android_download_url" value="{pigcms{$village_android_url}" size="60" validate="required:true" tips="Android下载地址">
                </td>
            </tr>
            </tbody>
        </table>
