	...
	<form id="myform" method="post" action="{pigcms{:U('Express/modify')}" frame="true" refresh="true">
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				...
				<td><input type="text" class="input fl" name="kuaidiniao_code" size="20" placeholder="请输入编码" validate="maxlength:50,required:true,english:true" tips="以 快递鸟 的快递公司编码为准，请填写准确，否则用户和商家用不了快递查询。"/></td>
			</tr>
			<tr>
				<th width="80">网址</th>
